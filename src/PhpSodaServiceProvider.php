<?php namespace Davidsierradz\Socrata;

use Illuminate\Support\ServiceProvider as LaravelServiceProvider;
use Davidsierradz\Socrata\SodaClient;
use Davidsierradz\Socrata\SodaDataset;

class PhpSodaServiceProvider extends LaravelServiceProvider {
    ...
    public function register() {
        ...
        $this->app->bind(SodaDataset::class, function() {
            return function ($datasetID) {
                return new SodaDataset(
                    new SodaClient('www.datos.gov.co'), $datasetID);
            };
        });
